...
if (!isset($_GET['id'])) {
    die("No baptismal record ID provided");
}
...
try {
    ...
    if (!$baptismal) {
        die("Baptismal record not found");
    }
...
<head>
    ...
    <title>Baptismal Certificate - <?php echo htmlspecialchars($baptismal['name']); ?></title>
...
<body>
    <div class="certificate">
        <div class="certificate-content">
            <img src="certificates/Baptismal Certificate.jpg" alt="Baptismal Certificate">
